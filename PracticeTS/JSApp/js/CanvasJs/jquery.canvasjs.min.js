...
a.axisY.dataInfo,b=a.axisX.dataInfo,c,e,g=!1,h=[],l=[],n=Infinity,k=-Infinity,r=0;r<a.dataSeriesIndexes.length;r++){var q=this.data[a.dataSeriesIndexes[r]],m=0,d=!1,v=!1,pa;if("normal"===q.axisPlacement||"xySwapped"===q.axisPlacement)var C=a.axisX.sessionVariables.newViewportMinimum?a.axisX.sessionVariables.newViewportMinimum:this.options.axisX&&this.options.axisX.viewportMinimum?this.options.axisX.viewportMinimum:this.options.axisX&&this.options.axisX.minimum?this.options.axisX.minimum:-Infinity,
...
(f.viewPortMax=a)));for(m in l)l.hasOwnProperty(m)&&!isNaN(m)&&(a=l[m],a<f.min&&(f.min=a),a>f.max&&(f.max=Math.max(a,k)),m<b.viewPortMin||m>b.viewPortMax||(a<f.viewPortMin&&(f.viewPortMin=a),a>f.viewPortMax&&(f.viewPortMax=Math.max(a,k))))}};s.prototype._processStacked100PlotUnit=function(a){if(a.dataSeriesIndexes&&!(1>a.dataSeriesIndexes.length)){for(var f=a.axisY.dataInfo,b=a.axisX.dataInfo,c,e,g=!1,h=!1,l=!1,n=[],k=0;k<a.dataSeriesIndexes.length;k++){var r=this.data[a.dataSeriesIndexes[k]],q=0,
m=!1,d=!1,v;if("normal"===r.axisPlacement||"xySwapped"===r.axisPlacement)var pa=a.axisX.sessionVariables.newViewportMinimum?a.axisX.sessionVariables.newViewportMinimum:this.options.axisX&&this.options.axisX.viewportMinimum?this.options.axisX.viewportMinimum:this.options.axisX&&this.options.axisX.minimum?this.options.axisX.minimum:-Infinity,C=a.axisX.sessionVariables.newViewportMaximum?a.axisX.sessionVariables.newViewportMaximum:this.options.axisX&&this.options.axisX.viewportMaximum?this.options.axisX.viewportMaximum:
this.options.axisX&&this.options.axisX.maximum?this.options.axisX.maximum:Infinity;if(r.dataPoints[q].x&&r.dataPoints[q].x.getTime||"dateTime"===r.xValueType)g=!0;for(q=0;q<r.dataPoints.length;q++){"undefined"===typeof r.dataPoints[q].x&&(r.dataPoints[q].x=q+(a.axisX.logarithmic?1:0));r.dataPoints[q].x.getTime?(g=!0,c=r.dataPoints[q].x.getTime()):c=r.dataPoints[q].x;e=y(r.dataPoints[q].y)?null:r.dataPoints[q].y;c<b.min&&(b.min=c);c>b.max&&(b.max=c);if(0<q){if(a.axisX.logarithmic){var u=c/r.dataPoints[q-
1].x;1>u&&(u=1/u);b.minDiff>u&&1!==u&&(b.minDiff=u)}else u=c-r.dataPoints[q-1].x,0>u&&(u*=-1),b.minDiff>u&&0!==u&&(b.minDiff=u);y(e)||null===r.dataPoints[q-1].y||(a.axisY.logarithmic?0<e&&(u=e/r.dataPoints[q-1].y,1>u&&(u=1/u),f.minDiff>u&&1!==u&&(f.minDiff=u)):(u=e-r.dataPoints[q-1].y,0>u&&(u*=-1),f.minDiff>u&&0!==u&&(f.minDiff=u)))}if(c<pa&&!m)null!==e&&(v=c);else{if(!m&&(m=!0,0<q)){q-=2;continue}if(c>C&&!d)d=!0;else if(c>C&&d)continue;r.dataPoints[q].label&&(a.axisX.labels[c]=r.dataPoints[q].label);
c<b.viewPortMin&&(b.viewPortMin=c);c>b.viewPortMax&&(b.viewPortMax=c);null===e?b.viewPortMin===c&&v<c&&(b.viewPortMin=v):(a.yTotals[c]=(a.yTotals[c]?a.yTotals[c]:0)+e,0<=e?h=!0:0>e&&(l=!0),n[c]=n[c]?n[c]+Math.abs(e):Math.abs(e))}}r.axisX.valueType=r.xValueType=g?"dateTime":"number"}a.axisY.logarithmic?(f.max=y(f.viewPortMax)?99*Math.pow(a.axisY.logarithmBase,-0.05):Math.max(f.viewPortMax,99*Math.pow(a.axisY.logarithmBase,-0.05)),f.min=y(f.viewPortMin)?1:Math.min(f.viewPortMin,1)):h&&!l?(f.max=y(f.viewPortMax)?
...
if((e=k.dataPoints[r].y)&&e.length){g=Math.min.apply(null,e);h=Math.max.apply(null,e);v=!0;for(var E=0;E<e.length;E++)null===e.k&&(v=!1);v&&(q||(pa=d),d=c)}c<b.min&&(b.min=c);c>b.max&&(b.max=c);g<f.min&&(f.min=g);h>f.max&&(f.max=h);0<r&&(a.axisX.logarithmic?(v=c/k.dataPoints[r-1].x,1>v&&(v=1/v),b.minDiff>v&&1!==v&&(b.minDiff=v)):(v=c-k.dataPoints[r-1].x,0>v&&(v*=-1),b.minDiff>v&&0!==v&&(b.minDiff=v)),e&&(null!==e[0]&&k.dataPoints[r-1].y&&null!==k.dataPoints[r-1].y[0])&&(a.axisY.logarithmic?(v=e[0]/
k.dataPoints[r-1].y[0],1>v&&(v=1/v),f.minDiff>v&&1!==v&&(f.minDiff=v)):(v=e[0]-k.dataPoints[r-1].y[0],0>v&&(v*=-1),f.minDiff>v&&0!==v&&(f.minDiff=v))));if(!(c<C)||q){if(!q&&(q=!0,0<r)){r-=2;d=pa;continue}if(c>u&&!m)m=!0;else if(c>u&&m)continue;k.dataPoints[r].label&&(a.axisX.labels[c]=k.dataPoints[r].label);c<b.viewPortMin&&(b.viewPortMin=c);c>b.viewPortMax&&(b.viewPortMax=c);if(b.viewPortMin===c&&e)for(E=0;E<e.length;E++)if(null===e[E]&&d<c){b.viewPortMin=d;break}null===e?b.viewPortMin===c&&d<c&&
(b.viewPortMin=d):(g<f.viewPortMin&&(f.viewPortMin=g),h>f.viewPortMax&&(f.viewPortMax=h))}}k.axisX.valueType=k.xValueType=l?"dateTime":"number"}};s.prototype._processSpecificPlotUnit=function(a){if("waterfall"===a.type&&a.dataSeriesIndexes&&!(1>a.dataSeriesIndexes.length))for(var f=a.axisY.dataInfo,b=a.axisX.dataInfo,c,e,g=!1,h=0;h<a.dataSeriesIndexes.length;h++){var l=this.data[a.dataSeriesIndexes[h]],n=0,k=!1,r=!1,q=c=0;if("normal"===l.axisPlacement||"xySwapped"===l.axisPlacement)var m=a.axisX.sessionVariables.newViewportMinimum?
...
1].y&&(a.axisY.logarithmic?(e=l.dataPointEOs[n].cumulativeSum/l.dataPointEOs[n-1].cumulativeSum,1>e&&(e=1/e),f.minDiff>e&&1!==e&&(f.minDiff=e)):(e=l.dataPointEOs[n].cumulativeSum-l.dataPointEOs[n-1].cumulativeSum,0>e&&(e*=-1),f.minDiff>e&&0!==e&&(f.minDiff=e)))),!(c<m)||k){if(!k&&(k=!0,0<n)){n-=2;continue}if(c>d&&!r)r=!0;else if(c>d&&r)continue;l.dataPoints[n].label&&(a.axisX.labels[c]=l.dataPoints[n].label);c<b.viewPortMin&&(b.viewPortMin=c);c>b.viewPortMax&&(b.viewPortMax=c);0<n&&(l.dataPointEOs[n-
1].cumulativeSum<f.viewPortMin&&(f.viewPortMin=l.dataPointEOs[n-1].cumulativeSum),l.dataPointEOs[n-1].cumulativeSum>f.viewPortMax&&(f.viewPortMax=l.dataPointEOs[n-1].cumulativeSum));l.dataPointEOs[n].cumulativeSum<f.viewPortMin&&(f.viewPortMin=l.dataPointEOs[n].cumulativeSum);l.dataPointEOs[n].cumulativeSum>f.viewPortMax&&(f.viewPortMax=l.dataPointEOs[n].cumulativeSum)}l.axisX.valueType=l.xValueType=g?"dateTime":"number"}};s.prototype.calculateAutoBreaks=function(){function a(a,c,b,e){if(e)return b=
...
0)+a[d].lineCoordinates.x1));if(f&&0<f.length)for(d=0;d<f.length;d++)f[d].calculateValueToPixelConversionParameters(),f[d].calculateBreaksSizeInValues(),f[d]._labels&&1<f[d]._labels.length&&(z=(f[d].logarithmic?Math.log(f[d]._labels[1].position/f[d].viewportMinimum)/f[d].conversionParameters.lnLogarithmBase:f[d]._labels[1].position-f[d].viewportMinimum)*Math.abs(f[d].conversionParameters.pixelPerUnit)+f[d].lineCoordinates.x1,h=f[d]._labels[f[d]._labels.length-("dateTime"===f[d].valueType?2:1)].position,
h=f[d].getApparentDifference(f[d].viewportMinimum,h),J=f[d].logarithmic?(1<h?Math.log(h)/f[d].conversionParameters.lnLogarithmBase*Math.abs(f[d].conversionParameters.pixelPerUnit):0)+f[d].lineCoordinates.x1:(0<h?h*Math.abs(f[d].conversionParameters.pixelPerUnit):0)+f[d].lineCoordinates.x1);for(d=0;d<m.length;d++)"axisY"===m[d].type&&(m[d].calculateValueToPixelConversionParameters(),m[d].calculateBreaksSizeInValues());if(0<s){if(a&&0<a.length)for(d=0;d<a.length;d++)p=P[s-1][d]===P[s][d]?!0:!1;else p=
!0;if(f&&0<f.length)for(d=0;d<f.length;d++)L=Q[s-1][d]===Q[s][d]?!0:!1;else L=!0;if(b&&0<b.length)for(d=0;d<b.length;d++)K=S[s-1][d]===S[s][d]?!0:!1;else K=!0;if(c&&0<c.length)for(d=0;d<c.length;d++)O=R[s-1][d]===R[s][d]?!0:!1;else O=!0}if(p&&L&&K&&O)break;s++}q.save();q.beginPath();a[0]&&q.rect(5,a[0].bounds.y1,a[0].chart.width-10,a[0].bounds.height);f[0]&&q.rect(5,f[f.length-1].bounds.y1,f[0].chart.width-10,f[0].bounds.height);q.clip();if(a&&0<a.length)for(d=0;d<a.length;d++)a[d].calculateStripLinesThicknessInValues(),
...
[];I=[];t=[];J=[];u=[];P=[];Q=[];for(S=[];4>s;){X=Y=N=V=$=M=W=e=U=R=T=D=0;if(a&&0<a.length)for(t=[],d=Y=0;d<a.length;d++)t.push(Math.ceil(a[d]?a[d].createLabelsAndCalculateWidth():0)),Y+=t[d],e+=a[d]?a[d].margin:0;else t.push(Math.ceil(a[0]?a[0].createLabelsAndCalculateWidth():0));Q.push(t);if(f&&0<f.length)for(J=[],d=X=0;d<f.length;d++)J.push(Math.ceil(f[d]?f[d].createLabelsAndCalculateWidth():0)),X+=J[d],W+=f[d]?f[d].margin:0;else J.push(Math.ceil(f[0]?f[0].createLabelsAndCalculateWidth():0));S.push(J);
if(b&&0<b.length)for(d=0;d<b.length;d++)b[d].lineCoordinates={},h=Math.round(g.x1+Y+e),n=Math.round(g.x2-X-W>r.width-10?r.width-10:g.x2-X-W),b[d].labelAutoFit&&!y(x)&&(0<!a.length&&(h=0>b[d].labelAngle?Math.max(h,x):0===b[d].labelAngle?Math.max(h,x/2):h),0<!f.length&&(n=0<b[d].labelAngle?n-A/2:0===b[d].labelAngle?n-A/2:n)),b[d].lineCoordinates.x1=h,b[d].lineCoordinates.x2=n,b[d].lineCoordinates.width=Math.abs(n-h),b[d].title&&(b[d]._titleTextBlock.maxWidth=0<b[d].titleMaxWidth&&b[d].titleMaxWidth<
...
0<c[d].titleMaxWidth&&c[d].titleMaxWidth<c[d].lineCoordinates.width?c[d].titleMaxWidth:c[d].lineCoordinates.width);if(b&&0<b.length)for(z=[],d=V=0;d<b.length;d++)z.push(Math.ceil(b[d]?b[d].createLabelsAndCalculateHeight():0)),V+=z[d]+b[d].margin,M+=b[d].margin;else z.push(Math.ceil(b[0]?b[0].createLabelsAndCalculateHeight():0));u.push(z);if(c&&0<c.length)for(I=[],d=N=0;d<c.length;d++)I.push(Math.ceil(c[d]?c[d].createLabelsAndCalculateHeight():0)),N+=I[d],$+=c[d].margin;else I.push(Math.ceil(c[0]?
c[0].createLabelsAndCalculateHeight():0));P.push(I);if(b&&0<b.length)for(d=0;d<b.length;d++)0<b[d]._labels.length&&(k=b[d]._labels[0],l=b[d]._labels[b[d]._labels.length-1],x=k.textBlock.width*Math.cos(Math.PI/180*Math.abs(k.textBlock.angle))+(k.textBlock.height-l.textBlock.fontSize/2)*Math.sin(Math.PI/180*Math.abs(k.textBlock.angle)),A=l.textBlock.width*Math.cos(Math.PI/180*Math.abs(l.textBlock.angle))+(l.textBlock.height-l.textBlock.fontSize/2)*Math.sin(Math.PI/180*Math.abs(l.textBlock.angle)));
...
else for(d=0;d<b.length;d++)r.sessionVariables.axisY.height=z[d];if(b&&0<b.length)for(d=b.length-1;0<=d;d--)l=Math.round(g.y2),k=Math.round(g.y2>b[d].chart.height-10?b[d].chart.height-10:g.y2),b[d].lineCoordinates.y1=l-(z[d]+b[d].margin+D),b[d].lineCoordinates.y2=l-(z[d]+b[d].margin+D),b[d].bounds={x1:h,y1:l-(z[d]+D+b[d].margin),x2:n,y2:k-(D+b[d].margin),width:n-h,height:z[d]},b[d].title&&(b[d]._titleTextBlock.maxWidth=0<b[d].titleMaxWidth&&b[d].titleMaxWidth<b[d].lineCoordinates.width?b[d].titleMaxWidth:
b[d].lineCoordinates.width),D+=z[d]+b[d].margin;if(c&&0<c.length)for(d=c.length-1;0<=d;d--)c[d]&&(l=Math.round(g.y1),k=Math.round(g.y1+(I[d]+c[d].margin+T)),c[d].lineCoordinates.y1=k,c[d].lineCoordinates.y2=k,c[d].bounds={x1:h,y1:l+(c[d].margin+T),x2:n,y2:k,width:n-h,height:N},c[d].title&&(c[d]._titleTextBlock.maxWidth=0<c[d].titleMaxWidth&&c[d].titleMaxWidth<c[d].lineCoordinates.width?c[d].titleMaxWidth:c[d].lineCoordinates.width),T+=I[d]+c[d].margin);if(a&&0<a.length)for(d=0;d<a.length;d++){M=a[d]._labels&&
0<a[d]._labels.length?a[d]._labels[0].textBlock.fontSize/2:0;h=Math.round(g.x1+e);l=c&&0<c.length?Math.round(c[0]?c[0].lineCoordinates.y2:g.y1<Math.max(M,10)?Math.max(M,10):g.y1):g.y1<Math.max(M,10)?Math.max(M,10):g.y1;n=Math.round(g.x1+Y+e);k=b&&0<b.length?Math.round(b[0]?b[0].lineCoordinates.y1:g.y2-V>r.height-Math.max(M,10)?r.height-Math.max(M,10):g.y2-V):g.y2>r.height-Math.max(M,10)?r.height-Math.max(M,10):g.y2;if(b&&0<b.length)for(M=0;M<b.length;M++)b[M]&&b[M].labelAutoFit&&(n=0>b[M].labelAngle?
Math.max(n,x):0===b[M].labelAngle?Math.max(n,x/2):n,h=0>b[M].labelAngle||0===b[M].labelAngle?n-Y:h);if(c&&0<c.length)for(M=0;M<c.length;M++)c[M]&&c[M].labelAutoFit&&(n=c[M].lineCoordinates.x1,h=n-Y);a[d].lineCoordinates={x1:n-R,y1:l,x2:n-R,y2:k,height:Math.abs(k-l)};a[d].bounds={x1:n-(t[d]+R),y1:l,x2:n,y2:k,width:n-h,height:k-l};a[d].title&&(a[d]._titleTextBlock.maxWidth=0<a[d].titleMaxWidth&&a[d].titleMaxWidth<a[d].lineCoordinates.height?a[d].titleMaxWidth:a[d].lineCoordinates.height);a[d].calculateValueToPixelConversionParameters();
a[d].calculateBreaksSizeInValues();R+=t[d]+a[d].margin}if(f&&0<f.length)for(d=0;d<f.length;d++){M=f[d]._labels&&0<f[d]._labels.length?f[d]._labels[0].textBlock.fontSize/2:0;h=Math.round(g.x1-e);l=c&&0<c.length?Math.round(c[0]?c[0].lineCoordinates.y2:g.y1<Math.max(M,10)?Math.max(M,10):g.y1):g.y1<Math.max(M,10)?Math.max(M,10):g.y1;n=Math.round(g.x2-X-W);k=b&&0<b.length?Math.round(b[0]?b[0].lineCoordinates.y1:g.y2-V>r.height-Math.max(M,10)?r.height-Math.max(M,10):g.y2-V):g.y2>r.height-Math.max(M,10)?
r.height-Math.max(M,10):g.y2;if(b&&0<b.length)for(M=0;M<b.length;M++)b[M]&&b[M].labelAutoFit&&(n=0>b[M].labelAngle?Math.max(n,x):0===b[M].labelAngle?Math.max(n,x/2):n,h=0>b[M].labelAngle||0===b[M].labelAngle?n-X:h);if(c&&0<c.length)for(M=0;M<c.length;M++)c[M]&&c[M].labelAutoFit&&(n=c[M].lineCoordinates.x2,h=n-X);f[d].lineCoordinates={x1:n+U,y1:l,x2:n+U,y2:k,height:Math.abs(k-l)};f[d].bounds={x1:h,y1:l,x2:n+J[d]+U,y2:k,width:n-h,height:k-l};f[d].title&&(f[d]._titleTextBlock.maxWidth=0<f[d].titleMaxWidth&&
f[d].titleMaxWidth<f[d].lineCoordinates.height?f[d].titleMaxWidth:f[d].lineCoordinates.height);f[d].calculateValueToPixelConversionParameters();f[d].calculateBreaksSizeInValues();U+=J[d]+f[d].margin}for(d=0;d<m.length;d++)"axisY"===m[d].type&&(m[d].calculateValueToPixelConversionParameters(),m[d].calculateBreaksSizeInValues());if(0<s){if(a&&0<a.length)for(d=0;d<a.length;d++)p=Q[s-1][d]===Q[s][d]?!0:!1;else p=!0;if(f&&0<f.length)for(d=0;d<f.length;d++)L=S[s-1][d]===S[s][d]?!0:!1;else L=!0;if(b&&0<
b.length)for(d=0;d<b.length;d++)K=u[s-1][d]===u[s][d]?!0:!1;else K=!0;if(c&&0<c.length)for(d=0;d<c.length;d++)O=P[s-1][d]===P[s][d]?!0:!1;else O=!0}if(p&&L&&K&&O)break;s++}if(b&&0<b.length)for(d=0;d<b.length;d++)b[d].calculateStripLinesThicknessInValues(),b[d].calculateBreaksInPixels(),b[d].renderLabelsTicksAndTitle();if(c&&0<c.length)for(d=0;d<c.length;d++)c[d].calculateStripLinesThicknessInValues(),c[d].calculateBreaksInPixels(),c[d].renderLabelsTicksAndTitle();if(a&&0<a.length)for(d=0;d<a.length;d++)a[d].calculateStripLinesThicknessInValues(),
...
this.stripLines[a].startValue)-f)/2;this.stripLines[a].thickness=f;this.stripLines[a]._thicknessType="value"}};B.prototype.calculateBreaksSizeInValues=function(){for(var a="left"===this._position||"right"===this._position?this.lineCoordinates.height||this.chart.height:this.lineCoordinates.width||this.chart.width,f=this.scaleBreaks?this.scaleBreaks._appliedBreaks:[],b=this.conversionParameters.pixelPerUnit||a/(this.logarithmic?this.conversionParameters.maximum/this.conversionParameters.minimum:this.conversionParameters.maximum-
this.conversionParameters.minimum),c=this.scaleBreaks&&!y(this.scaleBreaks.options.spacing),e,g=0;g<f.length;g++)e=c||!y(f[g].options.spacing),f[g].spacing=O(f[g].spacing,a,8,e?0.1*a:8,e?0:3)<<0,f[g].size=0>f[g].spacing?0:Math.abs(f[g].spacing/b),this.logarithmic&&(f[g].size=Math.pow(this.logarithmBase,f[g].size))};B.prototype.calculateBreaksInPixels=function(){if(!(this.scaleBreaks&&0>=this.scaleBreaks._appliedBreaks.length)){var a=this.scaleBreaks?this.scaleBreaks._appliedBreaks:[];a.length&&(this.scaleBreaks.firstBreakIndex=
this.scaleBreaks.lastBreakIndex=null);for(var f=0;f<a.length&&!(a[f].startValue>this.conversionParameters.maximum);f++)a[f].endValue<this.conversionParameters.minimum||(y(this.scaleBreaks.firstBreakIndex)&&(this.scaleBreaks.firstBreakIndex=f),a[f].startValue>=this.conversionParameters.minimum&&(a[f].startPixel=this.convertValueToPixel(a[f].startValue),this.scaleBreaks.lastBreakIndex=f),a[f].endValue<=this.conversionParameters.maximum&&(a[f].endPixel=this.convertValueToPixel(a[f].endValue)))}};B.prototype.renderLabelsTicksAndTitle=
...
e&&this.labelAutoFit&&(f=!0)}if("left"===this._position||"right"===this._position)if(this.logarithmic&&!this.equidistantInterval&&this.labelAutoFit){for(var b=[],r,l=this.viewportMaximum,n=this.lineCoordinates.height/Math.log(this.range),k=this._labels.length-1;0<=k;k--){q=this._labels[k];if(q.position<this.viewportMinimum)break;q.position>this.viewportMaximum||!(k===this._labels.length-1||r<Math.log(l/q.position)*n)||(b.push(q),l=q.position,r=q.textBlock.height*Math.abs(Math.cos(Math.PI/180*this.labelAngle))+
...
b.type,b.size,b.color,b.borderColor,b.borderThickness)}}};return s}();Ka.Chart.version="v2.1.2 GA"})();
